...
function showFlag(flag){
  ...
  card.innerHTML='<div class="flag-label">LAB COMPLETE</div><h2>🏁 Investigation Complete</h2><p>Sarah reviewed Alex’s evidence. The Support Desk issue has been identified.</p><div class="flag">'+flag+"</div>";
